...
This hook automatically injects constitutional governance context on every user message to ensure compliance with all 16 principles of the Specification-Driven Development Constitution v3.3.0.
...
- Audit logging
- Pure bash fallback for jq
- 4-step pre-flight protocol injection

...
mkdir -p "$FEATURE_DIR"
TEMPLATE="$REPO_ROOT/.logic-loom/templates/plan-template.md"
[[ -f "$TEMPLATE" ]] && cp "$TEMPLATE" "$IMPL_PLAN"

# This script only scaffolds; the AI generates the actual plan content afterward.
echo ""
echo "=========================================="
...
echo ""
echo "Next: AI will generate plan content"
echo "=========================================="
echo ""

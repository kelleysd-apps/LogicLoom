...
# Check for agent context files (Plugin-First Architecture)
AGENT_COUNT=0
...
# Check agent files live in plugins (Plugin-First Architecture)
AGENT_ORG=true
...
# Check skills live in plugins (Plugin-First Architecture)
SKILL_ORG=true

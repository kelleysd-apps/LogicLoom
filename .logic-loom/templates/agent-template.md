...
- **Primary Authority**: `.logic-loom/memory/constitution.md` (v3.3.0 - 16 principles)
...
- Keywords matching department patterns (see `.logic-loom/memory/agent-collaboration.md`)

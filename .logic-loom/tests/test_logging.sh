...
TEST_LOG_DIR=".logic-loom/logs/test"
...
test_file_output() {
    ...
    [[ -d ".logic-loom/logs/operations" ]] && echo -e "${TEST_COLOR_PASS}✓${TEST_COLOR_RESET} operations/ directory exists" || echo -e "${TEST_COLOR_FAIL}✗${TEST_COLOR_RESET} operations/ directory exists"
    TESTS_RUN=$((TESTS_RUN + 1))
    [[ -d ".logic-loom/logs/operations" ]] && TESTS_PASSED=$((TESTS_PASSED + 1)) || TESTS_FAILED=$((TESTS_FAILED + 1))

    [[ -d ".logic-loom/logs/errors" ]] && echo -e "${TEST_COLOR_PASS}✓${TEST_COLOR_RESET} errors/ directory exists" || echo -e "${TEST_COLOR_FAIL}✗${TEST_COLOR_RESET} errors/ directory exists"
    TESTS_RUN=$((TESTS_RUN + 1))
    [[ -d ".logic-loom/logs/errors" ]] && TESTS_PASSED=$((TESTS_PASSED + 1)) || TESTS_FAILED=$((TESTS_FAILED + 1))

    [[ -d ".logic-loom/logs/metrics" ]] && echo -e "${TEST_COLOR_PASS}✓${TEST_COLOR_RESET} metrics/ directory exists" || echo -e "${TEST_COLOR_FAIL}✗${TEST_COLOR_RESET} metrics/ directory exists"
    TESTS_RUN=$((TESTS_RUN + 1))
    [[ -d ".logic-loom/logs/metrics" ]] && TESTS_PASSED=$((TESTS_PASSED + 1)) || TESTS_FAILED=$((TESTS_FAILED + 1))
}

...
**Supersedes**: v0.1 (Loom migration, Stage 8), which left gate semantics
...
These items are explicitly out of scope and still deferred at v0.2. **Hard-gate
semantics are not on this list** — they were considered and deliberately
declined; see *Disposition: the evaluator is ADVISORY ONLY*.

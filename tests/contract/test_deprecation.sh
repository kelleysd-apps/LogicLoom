#!/usr/bin/env bash
# Contract Tests: Plugin-First Architecture Validation
# Validates that all capabilities are served exclusively through plugins.
set -euo pipefail
...
assert "All 15 commands are bridge-generated (found ${BRIDGE_COUNT})" "[ $BRIDGE_COUNT -ge 15 ]"

# ── Plugins are authoritative ──
echo ""
echo "Plugin-First completeness"

...
**SKILL ACTIVATION**: Read and execute `plugins/sdd-orchestrator/skills/plan-review/SKILL.md`

## Execution Instructions

### Step 1: Load Skill
Read `plugins/sdd-orchestrator/skills/plan-review/SKILL.md` and follow its procedure. Reviewers (CEO, Eng, optional Design) run sequentially within this single Task context — do NOT spawn parallel sub-Tasks.

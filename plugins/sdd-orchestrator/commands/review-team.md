...
### Step 1: Load Skill
Read `plugins/sdd-orchestrator/skills/team-orchestration/SKILL.md` and follow its procedure in **parallel review** mode. The review team now has **4 reviewers** (was 3 in v5.x):

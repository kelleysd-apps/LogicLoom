...
# and cosine similarity matching. Stores vectors in .loom-memory-index/vectors/.
#
...
VECTOR_INDEX_DIR="${VECTOR_REPO_ROOT}/.loom-memory-index/vectors"
VECTOR_METADATA_DIR="${VECTOR_REPO_ROOT}/.loom-memory-index/metadata"
...
#!/usr/bin/env python3
"""
Vector Search Helper for loom-memory plugin.

...
constitutional_principles:
  ...
  - XIV  # AI Model Selection: Opus 4.6 default
...
```bash
source plugins/sdd-dev-loop/lib/termination-engine.sh
...
| **XIV (AI Model Selection)** | Opus 4.6 for orchestration and specialist agents. |
| **XVI (Plugin-First)** | Entire capability is an installable plugin at `plugins/sdd-dev-loop/`. |
...
```bash
source plugins/sdd-dev-loop/lib/permissions-sandbox.sh

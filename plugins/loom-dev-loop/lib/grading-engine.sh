#!/usr/bin/env bash
# grading-engine.sh — Quality grading engine for loom-dev-loop plugin
#
...
#   --model <model_id>  — AI model to use (default: claude-opus-4-8)
#
...
llm_judge() {
    local diff_file="" spec_file="" model="claude-opus-4-8"
...
_llm_judge_evaluate() {
    ...
    local valid_models="claude-opus-4-8 claude-sonnet-4-5-20250929 claude-haiku-4-5-20251001"

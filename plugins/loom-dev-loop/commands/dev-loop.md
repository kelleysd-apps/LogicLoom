...
**SKILL ACTIVATION**: This command activates the core-loop skill at `plugins/loom-dev-loop/skills/core-loop/SKILL.md`
...
**Activate**: `plugins/loom-dev-loop/skills/scope-detection/SKILL.md`
...
**Activate**: `plugins/loom-dev-loop/skills/session-manager/SKILL.md`
...
cp plugins/loom-dev-loop/templates/session-state.json "$RESEARCH_DIR/session.json"
...
**Activate**: `plugins/loom-dev-loop/skills/core-loop/SKILL.md`
...
**Activate**: `plugins/loom-dev-loop/skills/report-generator/SKILL.md`
...
**Session State Schema**: `plugins/loom-dev-loop/templates/session-state.json`

**Quality Grade Schema**: `plugins/loom-dev-loop/templates/quality-grade.json`

**Termination Event Schema**: `plugins/loom-dev-loop/templates/termination-event.json`
...
```bash
query_model_async "claude-opus-4-8" "$DECISION_POINT" &
PID_CLAUDE=$!
...
**Plugin**: loom-dev-loop v0.1.0
**Spec Reference**: `specs/feature-loom-dev-loop/spec.md`
**Data Model**: `specs/feature-loom-dev-loop/data-model.md`
